...
public class DragAndDropStep extends AbstractStep {
  ...
  public DragAndDropStep(List<String> args) {
    super(args, 2);
  ...
  public static class Factory implements Step.Factory {
    ...
    public Step create(List<String> args) {
      return new DragAndDropStep(args);
    }
  }

  @Override
  public StepOutcome runInternal(RunContext ctx) {
    ctx.getSelenium().dragAndDrop(ctx.substitute(locator), ctx.substitute(movementsString));
