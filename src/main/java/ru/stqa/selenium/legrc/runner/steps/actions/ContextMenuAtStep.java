...
public class ContextMenuAtStep extends AbstractStep {
  ...
  public static class Factory implements Step.Factory {
    ...
    public Step create(List<String> args) {
      return new ContextMenuAtStep(args);
    }
  }

  @Override
  public StepOutcome runInternal(RunContext ctx) {
    ctx.getSelenium().contextMenuAt(ctx.substitute(locator), ctx.substitute(coords));
